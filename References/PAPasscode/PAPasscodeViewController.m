...
- (void)loadView {
    ...
    passcodeTextField.backgroundColor = [UIColor orangeColor];
...
- (void)updateViewConstraints {
    ...
    [constraints addObject:[NSLayoutConstraint constraintWithItem:_inputPanel attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:contentView attribute:NSLayoutAttributeCenterY multiplier:1 constant:-100]];
